...
function App() {
  ...
  return(
    <div className="w-[100vw] h-[100vh] flex justify-center items-center bg-[#344155] flex-col gap-10" > 
      ...
      <button onClick={resetCounter} className="bg-[#0398d4] text-white px-5 py-2 rounded-sm text-lg">Reset</button>
    </div>
  );
}
export default App;
